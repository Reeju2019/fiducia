    ...
    return (
        <div className="bg-img-wrap">
                    ...
                    <nav className="navbar navbar-expand-lg navbar-light">
                        ...
                        <div className="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                            <ul className="navbar-nav">
                                ...
                                <li className="nav-item">
                                    <a className="nav-link" href="about-us.html">Product Configurator </a>
                                </li>
                                <li className="nav-item">
            ...
            className="banner-img-wrap">
                ...
                <div className="">
                    <div id="banner-slider" className="owl-carousel owl-theme carousel-fade">
                        <div className="container-fluid">
                            <div className="row banner-content-main align-items-center">
                                <div className="col-sm-12 col-lg-6">
                                    <div className="left-content pr-4">
                                        <h1 className="banner-title">Electronic Manufacturing Services made Simpler</h1>
                                        <p className="banner-text">We strive to be your trusted electronics manufacturing services provider. Own product of global standard at competitive rates</p>
                                        <button className="btn btn-brand">Start Building Your Brand</button>
                                    </div>
                                </div>
                                <div className="col-sm-12 col-lg-6">
